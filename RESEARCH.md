...
> **Shipped items** (✅) live in [`docs/SHIPPED-FEATURES.md`](docs/SHIPPED-FEATURES.md). This file is the catalog of what exists in the field and what we mapped onto our layers.
...
Shipped items (with version tags and rationale) live in [`docs/SHIPPED-FEATURES.md`](docs/SHIPPED-FEATURES.md). Items still in flight stay here until they migrate.
